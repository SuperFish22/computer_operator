...
Даный раздел посвещен вашей производсвенной практике. Вам надо успеть разработтать свое Web-приложение. Данная практика состоит из 2 модулей: 
1 - модуль это изучение js.
2 - модуль это изучение  node.js и сбор своего приложения.
...
* [Презентация](/lectures/js/lec7.pdf)
